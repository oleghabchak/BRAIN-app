...
const en = {
  ...
  forgotPasswordScreen: {
    ...
    emailInputPrompt: "Enter your email to reset your password.",
    emailFieldLabel: "Email",
    enterEmailPlaceholder: "Enter Email",
    resendCodeLink: "Resend it.",
    emailVerificationPrompt: "We’ve sent a 6-digit verification code to your email address",
    emailVerificationHint: "Please check your email to continue the password reset process.",
    setPasswordPrompt: "Set your new password.",
    newPasswordFieldLabel: "New Password",
    enterNewPasswordPlaceholder: "Enter new password",
    confirmNewPasswordFieldLabel: "Confirm New Password",
    ...
    emailBlankError: "Email can't be blank",
    emailLengthError: "Email must be at least 6 characters",
    emailInvalidError: "Email must be a valid email address (ex. john@mail.com)",
    verificationCodeEmptyError: "Verification code can't be empty",
    signupFailedError: "Signup failed",
    invalidGenderError: "Invalid gender selected.",
    invalidBirthDateFormatError: "Invalid birth date format.",
    emailVerificationFailedError: "Email verification failed",
    loginFailedError: "Email or password is not correct",
    somethingWentWrongError: "Something went wrong",
    failedToSendResetCodeError: "Failed to send password reset code.",
    invalidExpiredOtpError: "Invalid or expired OTP.",
    failedToResetPasswordError: "Failed to reset password."
  },
  demoNavigator: {
