...
const $viewPresets: Record<Presets, ThemedStyleArray<ViewStyle>> = {
  ...
  outline: [$styles.row, $baseViewStyle, ({ colors }) => ({ borderWidth: 2, borderColor: colors.palette.primary500 })],
};
...
const $pressedViewPresets: Record<Presets, ThemedStyle<ViewStyle>> = {
  default: ({ colors }) => ({ backgroundColor: colors.palette.primary600 }),
  outline: ({ colors }) => ({ borderColor: colors.palette.primary600, borderWidth: 2 }),
};

const $pressedTextPresets: Record<Presets, ThemedStyle<TextStyle>> = {
  default: ({ colors }) => ({ opacity: 0.9, color: colors.palette.neutral100 }),
  outline: ({ colors }) => ({ opacity: 0.9, color: colors.palette.primary600 }),
};
...
const $disabledTextPresets: Record<Presets, ThemedStyle<TextStyle>> = {
  default: ({ colors }) => ({ color: colors.palette.neutral100 }),
  outline: ({ colors }) => ({ color: colors.palette.neutral400 }),
};
